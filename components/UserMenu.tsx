...
export function UserMenu() {
  ...
  return (
    <>
      ...
      {/*
       * animationType="fade" on web uses CSS animation + onAnimationEnd.
       * If onAnimationEnd doesn't fire (known react-native-web issue) the modal
       * gets stuck at opacity:0 / pointerEvents:none and appears to do nothing.
       * Using "none" on web skips the animation entirely, avoiding the bug.
       */}
      <Modal
        visible={visible}
        transparent
